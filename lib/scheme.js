...
// `name` (the app's identity in /version) is included when provided, so it's no longer
// hard-coded in each consumer's runtime reader.
function buildCertificate({ version, channel, name } = {}) {
